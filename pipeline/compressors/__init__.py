...
class Compressor(object):
    ...
    def compress_js(self, paths, templates=None, source_map_filename=None, **kwargs):
        ...
        if compressor and source_map_filename:
            ...
            for path in paths:
                full_paths.append(path_prefix + path)
            (js, source_map) = compressor.compress_js_with_source_map(full_paths, source_map_filename, settings.PIPELINE_URL, path_prefix)
        else:
